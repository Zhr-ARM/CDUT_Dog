...
def generate_launch_description():
    ...
    perception_arg_names = [
        ...
        "template_min_y_span",
        "template_min_y_bins",
        "template_max_face_depth",
        "template_guard_y_margin",
        "template_max_guard_points",
        "template_max_guard_ratio",
        "min_face_points",
        "min_face_width_y",
        "max_face_width_y",
        "min_face_height_z",
        ...
        "min_layout_matches",
        "infer_missing_boxes",
        "use_layout_stabilizer",
        "layout_switch_confirm_frames",
        "layout_hold_frames",
        "layout_smoothing_alpha",
        "layout_max_x_shift",
        "layout_max_y_shift",
        "use_target_stabilizer",
        "target_confirm_frames",
        "target_hold_frames",
        "target_smoothing_alpha",
        "target_reset_distance",
        "processing_period",
        "marker_lifetime",
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "launch_teleop",
                default_value="false",
                description="Start joystick teleop with real control. Keep false while autonomous navigation publishes /cmd_vel.",
            ),
            DeclareLaunchArgument(
                "launch_imu",
                default_value="true",
                description="Start the WIT IMU driver with real control.",
            ),
