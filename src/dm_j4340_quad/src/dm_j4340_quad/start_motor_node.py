...
from dm_j4340_quad.dm_protocol import (
...
from dm_j4340_quad.ros_params import declare_parameters, load_parameters
from dm_j4340_quad.usbcan_serial import UsbCanFrame, UsbCanSerial
...
class StartMotorNode(Node):
    ...
    def __init__(self) -> None:
        ...
        7) 创建控制与状态定时器，进入周期运行。
        """
        super().__init__("start_motor_node")
        ...
        self.state_publisher = self.create_publisher(
            JointState, "/dm_j4340/joint_states", 10
        )

        # 设备状态摘要发布：在线性、温度、故障状态等。
        self.status_publisher = self.create_publisher(String, "/dm_j4340/status", 10)
